            ...
            <div className='hidden 800px:flex'>
                ...
                <>
                    ...
                    >
                        ...
                        {/* Text Labels */}
                        <span
                            className={`z-10 w-1/2 text-center text-sm font-semibold ${language === 'en' ? 'text-black' : 'text-gray-400'
                                }`}
                        >
                            EN
                        </span>
                        <span
                            className={`z-10 w-1/2 text-center text-sm font-semibold ${language === 'vi' ? 'text-white' : 'text-gray-400'
                                }`}
                        >
                            VI
                        </span>
